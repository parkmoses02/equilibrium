...
class Pendulum {
    ...
    public:
        ...
        // Energy-shaping swing-up. Angle convention: 0 rad hanging down,
        // +/-PI rad upright.
        void swingUp(TMC &tmc);
        bool readyForUpright() const;
        bool uprightLost() const;
        float getUprightError() const;
